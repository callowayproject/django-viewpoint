...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.non_staff_author'
        db.add_column('viewpoint_entry', 'non_staff_author', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding M2M table for field authors on 'Entry'
        db.create_table('viewpoint_entry_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entry', models.ForeignKey(orm['viewpoint.entry'], null=False)),
            ('staffmember', models.ForeignKey(orm['staff.staffmember'], null=False))
        ))
        db.create_unique('viewpoint_entry_authors', ['entry_id', 'staffmember_id'])

        # Changing field 'Entry.author'
        db.alter_column('viewpoint_entry', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.StaffMember']))

    def backwards(self, orm):
        
        # Deleting field 'Entry.non_staff_author'
        db.delete_column('viewpoint_entry', 'non_staff_author')

        # Removing M2M table for field authors on 'Entry'
        db.delete_table('viewpoint_entry_authors')

        # Changing field 'Entry.author'
        db.alter_column('viewpoint_entry', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
