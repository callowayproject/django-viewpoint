...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('viewpoint_entry', 'author_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Entry.author'
        raise RuntimeError("Cannot reverse this migration. 'Entry.author' and its values cannot be restored.")
