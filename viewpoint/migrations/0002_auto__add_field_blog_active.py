...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('viewpoint_blog', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Blog.active'
        db.delete_column('viewpoint_blog', 'active')
